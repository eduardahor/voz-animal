...
class StatusBadge extends StatelessWidget {
  ...
  Color get _cor {
    switch (status) {
      case StatusDenuncia.aberta:      return Colors.teal;
      ...
      case StatusDenuncia.recusada:    return Colors.red;
    }
  }
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Text(status.label,
        style: TextStyle(
            color: _cor, fontWeight: FontWeight.bold, fontSize: 12)),
  );
}
...
class UrgenciaBadge extends StatelessWidget {
  ...
  Color get _cor {
    switch (urgencia) {
      case ClassificacaoUrgencia.baixa:   return Colors.green;
      case ClassificacaoUrgencia.media:   return Colors.amber;
      case ClassificacaoUrgencia.alta:    return Colors.deepOrange;
      case ClassificacaoUrgencia.critica: return Colors.red;
    }
  }
