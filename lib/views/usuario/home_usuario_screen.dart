    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<Denuncia>>(
        ...
        builder: (context, snap) {
          final minhas    = snap.data ?? [];
          final emAnalise = minhas
              .where((d) => d.status == StatusDenuncia.emAnalise)
              .length;
          final resolvidas = minhas
            ...
            child: Column(
              ...
              children: [
                ...
                Row(children: [
                  ...
                  _Stat(label: 'Em análise',
                      valor: '$emAnalise', cor: Colors.orange),
                  const SizedBox(width: 8),
                  _Stat(label: 'Resolvidas',
                      valor: '$resolvidas', cor: Colors.green),
                ]),
                ...
                Card(
                  child: ListTile(
                    ...
                    subtitle: Text(
                        'Acompanhe o status das suas ${minhas.length} denúncias'),
