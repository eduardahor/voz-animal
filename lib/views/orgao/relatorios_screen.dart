...
class RelatoriosScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final rel = RelatorioService(svc.todas);
          ...
          : ListView(
              ...
              children: [
                ...
                _SecaoDistribuicao(
                  ...
                  dados:
                      rel.porTipo().map((k, v) => MapEntry(k.label, v)),
                  total: rel.total,
                ),
                const SizedBox(height: 16),
                _SecaoDistribuicao(
...
class _CardsResumo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GridView.count(
      ...
      children: [
        _CardKpi(
            label: 'Total', valor: '${rel.total}', cor: Colors.blue.shade700),
        _CardKpi(
            label: 'Pendentes',
            valor: '${rel.pendentes()}',
        ...
        _CardKpi(
            label: 'Resolvidas',
            valor: '${rel.porStatus()[StatusDenuncia.resolvida] ?? 0}',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(valor,
                style: TextStyle(
                    color: cor, fontSize: 24, fontWeight: FontWeight.bold)),
          ],
        ),
      ),
    );
...
class _SecaoDistribuicao extends StatelessWidget {
  ...
  const _SecaoDistribuicao(
      {required this.titulo, required this.dados, required this.total});
