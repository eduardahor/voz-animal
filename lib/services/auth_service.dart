...
class AuthService extends ChangeNotifier {
    ...
    _auth.authStateChanges().listen((user) async {
      ...
      try {
        ...
        if (doc.exists) {
          ...
          // Conta existe na Autenticação mas não tem perfil no Firestore
  ...
  Future<LoginResultado> login({
    ...
    try {
      ...
      // Busca o documento pelo UID (get() por ID conhecido — permitido
      // pelas regras) em vez de uma query por e-mail, que as regras
      // sempre rejeitam por não filtrar pelo ID do documento.
